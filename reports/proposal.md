...
- `formula1_2021season_calendar.csv` contains information on each of the 22 tracks used in 2021. Information about lap records, track dimensions, etc. The data was manually edited to reflect the 2023 season.

The track maps taken are extracted from [f1.com](https://www.formula1.com)

## Section 3: Research Questions and Usage Scenarios

Tom is an avid Formula 1 fan who wishes to explore in more detail where the 2023 Season of F1 races took place. He wants to be able to compare the different tracks on the calendar so he can get a better understanding of the differences between races, and he would like to get a better idea of where all the races are happening.
